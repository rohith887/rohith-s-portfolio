                 ...
                 <div className='flex px-5 pt-5 '>
                   <div className='flex text-2xl text-white'>
                    <RiGithubFill className='cursor-pointer ' size={30} color='white' 
                     onClick={() => window.open("https://github.com/rohith887/frost-style", "_blank")}/>
                   </div>
              ...
              <div className='w-full md:w-[500px] pt-10  ' >
                <div className='flex items-center justify-center'>
                 ...
                 <div className='flex pt-5 pl-5'>
                   <div className='flex text-2xl text-white'>
                    <RiGithubFill className='cursor-pointer ' size={30} color='white' 
                     onClick={() => window.open("https://github.com/rohith887/crypto-bolt", "_blank")}/>
                   </div>
                   <div className='flex pl-4 mt-1 text-2xl text-white'>
                    <FaExternalLinkAlt className='cursor-pointer' size={20} color='white' 
              ...
              <div className='w-full md:w-[500px] pt-10  ' >
                <div className='flex items-center justify-center'>
                 ...
                 <div className='flex pt-5 pl-5'>
                   <div className='flex text-2xl text-white'>
                    <RiGithubFill className='cursor-pointer ' size={30} color='white' 
                     onClick={() => window.open("https://github.com/rohith887/Bank-Mangement-System", "_blank")}/>
                   </div>
                   <div className='flex pl-4 mt-1 text-2xl text-white'>
                    <FaExternalLinkAlt className='cursor-pointer' size={20} color='white' 
